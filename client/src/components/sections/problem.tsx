      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center p-6">
            ...
            <h3 className="text-xl font-semibold text-skopia-dark mb-3">Inconsistent Yields</h3>
            <p className="text-skopia-dark">
          ...
          <div className="text-center p-6">
            ...
            <h3 className="text-xl font-semibold text-skopia-dark mb-3">Delayed Detection</h3>
            <p className="text-skopia-dark">
          ...
          <div className="text-center p-6">
            ...
            <h3 className="text-xl font-semibold text-skopia-dark mb-3">High Production Costs</h3>
            <p className="text-skopia-dark">
